...
export const CUES = [
  ...
  { t0: 46, t1: 55, text: 'In 1480 the wall was driven down to the water itself. Iron rings set in the brick moored the boats.' },
  { t0: 56, t1: 63, text: 'The Metzgerturm, the butchers’ tower of about 1340 — already out of plumb.' },
  ...
  { t0: 157, t1: 167, text: 'White on the meadows: fustian <i>(Barchent)</i>, linen warp and cotton weft, laid out to bleach. Some 60,000 pieces a year — the wealth behind the stone.' },
  { t0: 176, t1: 187, text: 'Ulm stands at its height: after Nuremberg, the largest territory of any imperial city in the Empire.' },
  { t0: 192, t1: 202, text: 'Within a lifetime come the Reformation, the shift of trade to the Atlantic, and the long decline. This is the summit.' },
  { t0: 204, t1: 212, kind: 'end', title: 'Ulm, 1500', sub: 'Reconstructed from documented building history and topography.<br>Conjectural in detail — see the accompanying notes.' },
];
